...
public class GuiSimpleTeleporter extends GuiContainer {

	public static final ResourceLocation texture = new ResourceLocation(DimensionShift.MODID, "textures/gui/teleporter.png");

	public TileEntitySimpleTeleporter teleporter;

	public GuiSimpleTeleporter(InventoryPlayer inventory, TileEntitySimpleTeleporter entity) {
		super(new ContainerSimpleTeleporter(inventory, entity));
